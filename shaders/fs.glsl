...
void main()
{
    // General calculations for entire shader
    ...
    float diffAngles = lightInnerCutoffAngleSpotlight - lightOuterCutoffAngleSpotlight;
    float intensity = clamp((theta - lightOuterCutoffAngleSpotlight) / diffAngles, 0.0, 1.0);
